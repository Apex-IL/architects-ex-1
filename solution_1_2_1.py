...
for step in range(max_steps):
    ...
    # PyTorch optimizers hold a fixed lr set at creation time. To change it each
    # step we overwrite param_groups directly — there is no other API for this.
    # get_lr() returns the right value for this step (warmup then cosine decay).
    lr = get_lr(step)
